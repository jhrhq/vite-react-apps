...
function LocationHeaderPagination() {
  return (
...
function LocationSecondarySidebar() {
  return (
...
function LocationSecondarySidebarForm() {
  return (
...
function LocationSecondarySidebarAction() {
  return (
    <div className="p-4 border-b">
...
function ItemDetailsDescription() {
  return (
...
function ItemDetailRow({ label, quantity, date }: ItemDetailRowProps) {
  return (
