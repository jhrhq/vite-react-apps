...
export function LogoIcon({ className, ...props }: IconProps) {
  return <FaBoxesStacked className={cn(className)} {...props} />;
}

export function LogoIconSidebar({ className, color, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
...
export default function Logo({
  ...
  return (
    <div
      className={cn(
        "inline-flex rounded-xl bg-blue-500 p-3 shadow-lg shadow-blue-500/30",
        className,
      )}
      {...props}
    >
