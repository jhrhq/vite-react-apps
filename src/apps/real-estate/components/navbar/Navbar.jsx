    ...
    <a
      ...
      className={`font-medium text-base py-2 text-white ${
        variant
          ...
          : "signUpBtn rounded-md bg-white/20 px-6 duration-300 ease-in-out hover:bg-white hover:text-slate-900"
      }`}
    >
      {text}
    </a>
...
function NavLinks({ text }) {
  return (
    <li className="group relative">
      <a
        href={`#${text}`}
        className="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-slate-900 group-hover:text-blue-600 dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 capitalize"
      >
        {text}
      </a>
    </li>
