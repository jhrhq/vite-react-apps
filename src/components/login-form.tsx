  ...
  return (
    <div className={cn("h-full w-full", className)} {...props}>
      <div className="h-dvh lg:grid lg:grid-cols-6">
        <div className="max-lg:hidden lg:col-span-3 xl:col-span-3 flex items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100">
        ...
        {/* Right column */}
        <div className="bg-[#F8FAFC] flex h-full flex-col items-center justify-center py-10 sm:px-5 lg:col-span-3 xl:col-span-3">
